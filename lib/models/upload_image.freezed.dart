...
abstract class $UploadImageCopyWith<$Res> {
  ...
  @useResult
  $Res call({String fileName, Uint8List data});
}
...
class _$UploadImageImpl implements _UploadImage {
  const _$UploadImageImpl({required this.fileName, required this.data});
  ...
  @override
  String toString() {
    return 'UploadImage(fileName: $fileName, data: $data)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, fileName, const DeepCollectionEquality().hash(data));
...
abstract class _UploadImage implements UploadImage {
  const factory _UploadImage(
      ...
      required final Uint8List data}) = _$UploadImageImpl;
